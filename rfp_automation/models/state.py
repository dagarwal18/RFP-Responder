...
Design rules:
  1. Each field is owned by one agent or orchestration step.
...
class RFPGraphState(BaseModel):
    ...
    Using Pydantic gives us validation and serialization for free.
    """
    ...
    # H1 Human Validation (owner: H1)
    review_package: ReviewPackage = Field(default_factory=ReviewPackage)
